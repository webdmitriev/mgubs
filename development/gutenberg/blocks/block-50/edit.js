...
import blockImage from '../../../../admin/assets/img/blocks/block-50.jpg';
      ...
      <div {...blockProps}>
        <div className="advanced-block">
          <div className="block-info">
            <span className="block-info-title">🎨 Block 50 - Новости: blockquote</span>
            <ToggleControl
          ...
          {isPreview && (
            <div className="advanced-block-content">
              <div className="advanced-block-text">
                ...
                <Flex>
                  <FlexBlock>
                    <label className="my-rich-text__label">Подпись</label>
                    <RichText
                      tagName="div"
                      label="Описание"
                      value={signature}
