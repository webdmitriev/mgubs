...
import blockImage from '../../../../admin/assets/img/blocks/block-19.jpg';
      ...
      <div {...blockProps}>
        <div className="advanced-block">
          <div className="block-info">
            <span className="block-info-title">🎨 Block 19 - Отзывы</span>
            <ToggleControl
              ...
              <div className="teachers-block-grid contacts-items numerations-items numerations-items-02">
                {items.map((item, index) => (
                  <div key={index} className="repeater-item numerations-item">
                    ...
                    {itemsList.renderBlockNineteen(item, index)}
                  </div>
                ))}
              </div>
              <Button
