...
import blockImage from '../../../../admin/assets/img/blocks/block-14.jpg';
      ...
      <div {...blockProps}>
        <div className="advanced-block">
          <div className="block-info">
            <span className="block-info-title">🎨 Block 14 - Кого мы ждём</span>
            <ToggleControl
              ...
              <div className="repeater-items" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', rowGap: '24px', columnGap: '24px', width: '100%' }}>
                {items.map((item, index) => (
                  <div key={index} className="repeater-item">
                    ...
                    {itemsList.renderBlockFourteen(item, index)}
                  </div>
                ))}
              </div>
              <Button
