...
import blockImage from '../../../../admin/assets/img/blocks/block-45.jpg';
      ...
      <div {...blockProps}>
        <div className="advanced-block">
          <div className="block-info">
            <span className="block-info-title">🎨 Block 45 - Партнеры</span>
            <ToggleControl
                  ...
                  <div className="teachers-block-grid contacts-items numerations-items numerations-items-02">
                    {items.map((item, index) => (
                      <div key={index} className="repeater-item numerations-item">
                        ...
                        {itemsList.renderBlockFortyFive(item, index)}
                      </div>
                    ))}
                  </div>
                  <div style={{ height: 8 }} />
                  <Button
                    onClick={() => itemsList.add({ icon: '', image: '', name: '', descr: '' })}
