...
import blockImage from '../../../../admin/assets/img/blocks/block-29.jpg';
      ...
      <div {...blockProps}>
        <div className="advanced-block">
          <div className="block-info">
            <span className="block-info-title">🎨 Block 29 - История школы: blocks</span>
            <ToggleControl
              ...
              <div className="teachers-block-grid contacts-items numerations-items numerations-items-02">
                {items.map((item, index) => (
                  <div key={index} className="repeater-item numerations-item">
                    ...
                    {itemsList.renderBlockTwentyNine(item, index)}
                  </div>
                ))}
              </div>
              <Button
                onClick={() => itemsList.add({ image: '', label: '', content: '', link: '' })}
