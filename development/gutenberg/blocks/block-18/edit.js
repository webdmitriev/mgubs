...
import blockImage from '../../../../admin/assets/img/blocks/block-18.jpg';
...
const Edit = ({ attributes, setAttributes }) => {
  const {
    title, descr, btnText, btnLink,
    bg1920Id, bg1920Data, bg991Id, bg991Data, bg576Id, bg576Data
  } = attributes;
          ...
          {isPreview && (
            <div className="advanced-block-content">
              <div className="advanced-block-text">
                ...
                <>
                  <label htmlFor="rich-description" className="my-rich-text__label">Кнопка: текст</label>
                  <RichText
                    id="rich-description"
                    tagName="div"
                    value={btnText}
                ...
                <>
                  <label htmlFor="rich-description" className="my-rich-text__label">Кнопка: ссылка</label>
                  <RichText
                    id="rich-description"
                    tagName="div"
                    value={btnLink}
