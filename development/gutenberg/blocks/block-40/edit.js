...
import blockImage from '../../../../admin/assets/img/blocks/block-40.jpg';
...
const Edit = ({ attributes, setAttributes }) => {
  ...
  const selector = usePostTypeSelector({
    ...
    mapItem: (post) => ({
      ...
      file: post.meta?.admission_file || false,
    }),
  });
      ...
      <div {...blockProps}>
        <div className="advanced-block">
          <div className="block-info">
            <span className="block-info-title">🎨 Block 40 - Приёмная комиссия</span>
            <ToggleControl
