...
import blockImage from '../../../../admin/assets/img/blocks/block-35.jpg';
...
const Edit = ({ attributes, setAttributes }) => {
  const { title, subTitle, descr, buttonText, buttonLink, imageData, imageId } = attributes;
      ...
      <div {...blockProps}>
        <div className="advanced-block">
          <div className="block-info">
            <span className="block-info-title">🎨 Block 35 - Грант</span>
            <ToggleControl
