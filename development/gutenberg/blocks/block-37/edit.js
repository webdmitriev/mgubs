...
import blockImage from '../../../../admin/assets/img/blocks/block-37.jpg';
      ...
      <div {...blockProps}>
        <div className="advanced-block">
          <div className="block-info">
            <span className="block-info-title">🎨 Block 37 - Контакты с текстом</span>
            <ToggleControl
          ...
          {isPreview && (
            <div className="advanced-block-content">
              <div className="advanced-block-text">
                ...
                <Flex>
                  <FlexBlock>
                    <label className="my-rich-text__label">Тексты:</label>
                    <div className="teachers-block-grid contacts-items numerations-items numerations-items-01">
                      {items.map((item, index) => (
                        <div key={index} className="repeater-item numerations-item">
                          ...
                          {itemsList.renderBlockThirtySeven(item, index)}
                        </div>
                      ))}
                    </div>
                    <div style={{ height: 12 }} />
                    <Button
                      onClick={() => itemsList.add({ title: '', descr: '' })}
